...
public class AssetAllowRuinedView extends JFrame implements ActionListener, ListSelectionListener {
	...
	JButton allowRuined = new JButton();
  ...
  public AssetAllowRuinedView() {
	...
	public void Init() throws Exception {
		...
		ResultSet rSet=assetsDaoMpl.getAllowBorrowedInfo(connection);
	...
	public void downInit() {
		...
		allowRuined.setText("报废");
		allowRuined.setFont(new Font("Dialog", 0, 12));
		downPanel.add(allowRuined);
		eixtInfo.setText("退出");
		...
		// 添加事件侦听
		allowRuined.addActionListener(this);

		eixtInfo.addActionListener(this);

		allowRuined.setEnabled(true);
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (obj == allowRuined) {
			try {
				...
				Connection connection = ConnectionFactory.getInstance().makeConnection();
				AssetsDaoMpl assetsDaoMpl=new AssetsDaoMpl();
				Assets assets=new Assets(jTextField1.getText(), jTextField2.getText(),jTextField3.getText(), 4, jTextField5.getText(), jTextField4.getText(),1);
