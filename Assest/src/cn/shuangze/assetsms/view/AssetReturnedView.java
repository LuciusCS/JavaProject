...
public class AssetReturnedView  extends JFrame implements ActionListener, ListSelectionListener {
	...
	public void Init() throws Exception {
		...
		ResultSet rSet=assetsDaoMpl.getReturenedInfo(connection);
