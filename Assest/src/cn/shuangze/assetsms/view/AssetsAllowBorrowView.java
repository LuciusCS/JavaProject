...
public class AssetsAllowBorrowView extends JFrame implements ActionListener, ListSelectionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (obj == borrowAsset) {
			try {
				...
				Connection connection = ConnectionFactory.getInstance().makeConnection();
				AssetsDaoMpl assetsDaoMpl=new AssetsDaoMpl();
				Assets assets=new Assets(jTextField1.getText(), jTextField2.getText(),jTextField3.getText(), 2, jTextField5.getText(), jTextField4.getText(),1);
				assetsDaoMpl.borrow(connection, assets);
				JOptionPane.showMessageDialog(null, "资产借用成功！", "资产借用", JOptionPane.INFORMATION_MESSAGE);
			} catch (Exception ex) {
